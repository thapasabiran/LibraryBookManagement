...
class BooksAdapter(private val onCardClick: (position: Int) -> Unit, private var books: List<Books>): RecyclerView.Adapter<ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var holder = LayoutInflater.from(parent.context).inflate(R.layout.book_details_layout, parent, false)
        return ViewHolder(holder, onCardClick)
    }
