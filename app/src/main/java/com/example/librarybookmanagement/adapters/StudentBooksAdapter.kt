...
class StudentBooksAdapter (private val onCardClick: (position: Int) -> Unit, private var books: List<Books>): RecyclerView.Adapter<StudentBooksViewHolder>()  {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StudentBooksViewHolder {
        ...
        return StudentBooksViewHolder(holder, onCardClick)
    }
...
class StudentBooksViewHolder(view: View, private val onCardClick: (position: Int) -> Unit): RecyclerView.ViewHolder(view), View.OnClickListener {
